...
void add_pairs(void)
{
    for (int i = 0; i < candidate_count; i++)
    {
        for (int j = i + 1; j < candidate_count; j++)
        {
            int preference_i = preferences[i][j];
            int preference_j = preferences[j][i];
            ...
            else if (preference_j > preference_i)
            {
...
void sort_pairs(void)
{
    for (int i = 0; i < pair_count - 1; i++)
    {
        ...
        {
            int margin_i = preferences[pairs[j].winner][pairs[j].loser];
            int margin_j = preferences[pairs[j + 1].winner][pairs[j + 1].loser];
